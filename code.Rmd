...
ggplot(data = merge( x = world, y = data , by.x="iso_a3",by.y = "LOCATION", all.x = T) %>% mutate(rapp = Value/pop_est) ) +
    geom_sf(aes(fill = rapp)) + 
...
plot3d(cons_prod_dt$values, cons_prod_dt$Value, cons_prod_dt$TIME, col="red", size=3)
